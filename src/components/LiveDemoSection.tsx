import { Play, ExternalLink, Eye, CheckCircle } from "lucide-react";
import { Button } from "./ui/button";

type LiveDemoSectionProps = {
  onPrimaryCTA?: () => void; // 🔑 same as HeroSection
};

export function LiveDemoSection({ onPrimaryCTA }: LiveDemoSectionProps) {
  return (
