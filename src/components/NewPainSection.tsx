      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Every day you wait, you're hemorrhaging money. Here's exactly where your revenue is leaking:
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-3 max-w-6xl mx-auto">
          {painPoints.map((pain, index) => (
            <div key={index} className="bg-white rounded-3xl p-8 shadow-lg border-l-4 border-red-500 hover:shadow-xl transition-all duration-300">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl max-w-4xl mx-auto border-2 border-red-200">
            ...
            <div className="grid sm:grid-cols-3 gap-6 mb-6">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Lost per month with slow site</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-red-600 mb-2">$12K</div>
                <div className="text-sm text-gray-600">Lost per month with broken booking</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-red-600 mb-2">$47K</div>
                <div className="text-sm text-gray-600">Average annual revenue loss</div>
              </div>
            </div>
            ...
            <button 
              onClick={() => {
                console.log("Pain section CTA clicked");
              }}
