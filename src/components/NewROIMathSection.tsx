...
export function NewROIMathSection({ onPrimaryCTA }: { onPrimaryCTA: () => void }) {
  return (
    <section id="roi" className="py-20 bg-gradient-to-br from-green-50 to-emerald-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            <span className="text-green-600">One Patient</span> Covers Your
            Investment.
          </h2>

          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            The math is simple. Your return is immediate. Everything after is
            pure profit.
          </p>
        </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8 items-center">
              ...
              <div className="text-center">
                ...
                <div className="bg-[#6B4EFF]/10 border-2 border-[#6B4EFF] rounded-2xl p-6">
                  ...
                  <div className="text-sm text-gray-600 mt-2">
                    From better website conversion
                  </div>
                </div>
              </div>
        ...
        <div className="bg-gradient-to-r from-[#6B4EFF] to-[#8B5CF6] text-white rounded-3xl p-8 lg:p-12 text-center">
          <h3 className="text-3xl lg:text-4xl font-bold mb-6">The Bottom Line</h3>
          ...
          <p className="text-xl mb-8 opacity-90 max-w-3xl mx-auto">
            "If your average package is worth $1,500, just one extra booking pays
            for your entire website fix. Everything after is profit."
          </p>
